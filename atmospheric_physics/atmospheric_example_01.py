    ...
    def __draw_skewt(self):
        ...
        try:
            if self.__current_mode2 == 'Isotherm':
                ...
                color = 'red'
            elif self.__current_mode2 == 'Dry adiabat':
                ...
                # Делим на 10 для точности
                theta_e = (self.__current_param_val2 / 10.0 + 273.15) * units.kelvin
